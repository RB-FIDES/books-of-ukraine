---
pipeline_stage: 1
database_file: "books-of-ukraine-1.sqlite"
generated_by: "manipulation/1-ellis-ua-admin.R"
tables: 9
record_count: 6804
data_types: ["book_publications", "dimensions", "ukrainian_admin", "territorial"]
dependencies: ["books-of-ukraine-0.sqlite", "KSE Ukrainian Hromada Dataset"]
size_mb: 1.96
...
**Pipeline Stage**: 1 - Ukrainian Administrative Integration  
**Database**: `books-of-ukraine-1.sqlite`  
**Generated by**: `manipulation/1-ellis-ua-admin.R`  
**Dependencies**: Stage 0 database + Ukrainian administrative datasets  
**Size**: 1.96 MB  
**Last Updated**: 2025-08-19

## Quick Stats
- **Tables**: 9 tables (4 core + 5 administrative)
- **Records**: 6,804 records (Stage 0 + Ukrainian administrative data)
- **Data Types**: Book publications + Ukrainian territorial data
- **Geographic Coverage**: 24 oblasts, 1,438 hromadas

## When to Use This Database
✅ **Use if**: You need territorial/regional analysis of publications  
✅ **Use if**: Correlating publishing data with administrative boundaries  
✅ **Use if**: Creating choropleth maps of Ukraine  
❌ **Don't use if**: You only need publication data (use Stage 0)  
❌ **Don't use if**: You need custom datasets (use Stage 2+)  
🔄 **Alternative**: For most analysis, use final database instead
