...
books_of_ukraine <- dbConnect(RSQLite::SQLite(), "data-private/derived/manipulation/SQLite/books-of-ukraine-wide.sqlite")
...
# ------------------------------- CREATE WIDE VERSIONS OF ALL TABLES --------------------------------

## ------- Connect to database -------
books_of_ukraine <- dbConnect(RSQLite::SQLite(), "data-private/derived/manipulation/SQLite/books-of-ukraine-wide.sqlite")

## ------- DS_YEAR_WIDE -------
dbWriteTable(books_of_ukraine, "ds_year_wide", ds_year, overwrite = TRUE)

## ------- DS_LANGUAGE_WIDE -------
dbWriteTable(books_of_ukraine, "ds_language_wide", ds_language, overwrite = TRUE)

## ------- DS_GENRE_WIDE -------
dbWriteTable(books_of_ukraine, "ds_genre_wide", ds_genre, overwrite = TRUE)

## ------- DS_PUBTYPE_WIDE -------
dbWriteTable(books_of_ukraine, "ds_pubtype_wide", ds_pubtype, overwrite = TRUE)

## ------- DS_GEOGRAPHY_WIDE -------
dbWriteTable(books_of_ukraine, "ds_geography_wide", ds_geography, overwrite = TRUE)

## ------- DS_UKR_RUS_WIDE -------
dbWriteTable(books_of_ukraine, "ds_ukr_rus_wide", ds_ukr_rus, overwrite = TRUE)

## ------- DS_GEOGRAPHY_LOOKER_WIDE -------
dbWriteTable(books_of_ukraine, "ds_geography_looker_wide", ds_geography_looker, overwrite = TRUE)
